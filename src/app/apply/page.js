            ...
            <div style={styles.formCard}>
                ...
                <div style={styles.formBody}>
                  ...
                  <div style={styles.row}>
                    <div style={styles.fieldGroup}>
                      ...
                      <input type="text" style={styles.input} placeholder="As per official documents" />
                    </div>
                  </div>
                  ...
                  <div style={styles.row}>
                    <div style={styles.fieldGroup}>
                      ...
                      <input type="email" style={styles.input} placeholder="official@example.com" />
                    </div>
                    <div style={styles.fieldGroup}>
                  ...
                  <div style={styles.row}>
                    <div style={styles.fieldGroup}>
                      ...
                      <textarea style={styles.textarea} rows={3} placeholder="Include City, State, and PIN Code"></textarea>
                    </div>
                  </div>
                </div>
              )}
                ...
                <div style={styles.formBody}>
                  ...
                  <div style={styles.row}>
                    <div style={styles.fieldGroup}>
                      ...
                      <input type="text" style={styles.input} placeholder="e.g. Largest gathering of..." />
                    </div>
                  </div>
                  ...
                  <div style={styles.row}>
                    <div style={styles.fieldGroup}>
                      ...
                      <textarea style={styles.textarea} rows={4} placeholder="Describe the rules followed, the measurements, and the exact achievement."></textarea>
                    </div>
                  </div>
                </div>
              )}
              ...
              {step === 3 && (
                <div style={styles.formBody}>
                  <div style={styles.uploadBox}>
                    ...
                    <button style={styles.uploadBtn}>Select File</button>
                  </div>
              ...
              {step < 4 && (
                <div style={styles.formFooter}>
                  {step > 1 ? (
                    <button onClick={() => setStep(step - 1)} style={styles.secondaryBtn}>Back</button>
                  ) : <div></div>}
                  
                  {step < 3 ? (
                    <button onClick={() => setStep(step + 1)} style={styles.primaryBtn}>
                      Save & Continue <ChevronRight size={18} />
                    </button>
                  ) : (
                    <button onClick={() => setStep(4)} style={styles.submitBtn}>
